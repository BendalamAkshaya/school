    ...
    <div className="container mx-auto px-4">
      <div className="max-w-3xl mx-auto text-center space-y-8">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">
          Join the Genesis International family! Our admission process is simple and friendly. We're here to help every step of the way.
        </p>
        ...
        <Button variant="hero" size="lg" className="rounded-full px-10 text-lg" asChild>
          <a href="#contact">
            <Sparkles size={18} />
            Apply for Admission
          </a>
